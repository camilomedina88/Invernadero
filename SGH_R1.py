...
while (1):
	...
	if target_mode != current_mode:
		...
		if current_mode == AUTO:
			...
			out_luz, out_hum, out_temp = ctrl_auto(luzActual, humedato, tempActual, sp_luz_h, sp_luz_l, sp_hum_h, sp_hum_l, sp_temp_h, sp_temp_l, out_luzActual, out_tempActual,out_humActual)
			api.save_collection([{'variable': '580a67d076254256cd395f0e','value':out_hum}, {'variable': '58126fc67625427440101759','value':out_temp}, {'variable': '5812621f7625421e625289ce','value':out_luz}])
		else:
